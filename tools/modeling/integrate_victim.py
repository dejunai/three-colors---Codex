...
SOURCE_NAME = "Meshy_Murder_Victim-texture.glb"
TARGET_NAME = "murder_victim.glb"
...
def process_victim() -> None:
    ...
    obj.name = "MurderVictimMesh"
    mesh.name = "MurderVictimMesh"

    root = bpy.data.objects.new("MurderVictim", None)
    root.empty_display_type = "PLAIN_AXES"
    bpy.context.collection.objects.link(root)
    obj.parent = root

    # Select root and mesh
