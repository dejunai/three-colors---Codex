...
SRC = ROOT / "Meshy_Steward-Animations.glb"
if not SRC.exists():
    SRC = ROOT / "archive" / "Meshy_Steward-Animations.glb"
...
act = bpy.data.actions.get("01a0c52e-c79d-71fb-b49b-e363e7cd0dd9")
if act:
...
out_path = Path("C:/Users/Dejunai/.gemini/antigravity/brain/174bb2e4-fa3a-4c53-a3df-f26cbf6e32d7/steward_preview.png")
