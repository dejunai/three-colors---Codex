...
- The corkboard linkage/connection mechanic requires substantive diegetic feedback for both positive and negative connection attempts:
  - **Positive feedback (`[this link makes sense]`)**: When a valid connection is drawn, provide evocative, investigative narrative reasoning explaining how and why the two observations corroborate or inform each other.
