...
Validation: `dialogue_live_flow.gd`, `instrument_voice_flow.gd`, and `dialogue_content_flow.gd` pass. The voice test covers the 144-entry manifest, all 403 explicitly authored NPC cues, fallback behavior, and every legacy intake-clerk card. No Web export or publication was performed.
