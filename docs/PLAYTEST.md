...
- Open the Tab menu and check the analogue pocket watch before and after 6 PM, then at midnight. Confirm the aperture changes from sun to moon, the hands and exact text agree, and midnight holds until sleep. F3 is a development-only brisk-speed toggle and must be off for pacing judgments.
