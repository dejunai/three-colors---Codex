...
| `OUTCOME: decision_id = value_id` | Commits one immutable branch result when the entire chosen path finishes. On replay, that decision presents only its committed branch. |
