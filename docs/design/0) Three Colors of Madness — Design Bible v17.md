...
**\*\*Polished draft — content faithful to source; TDD not included.\*\***
...
**Color is the baseline this section names outright because it's the one that went missing and prompted this whole pass, but it is not the only fixed axis — sound (see the Walter passage above, and each protagonist's own section for Ward and Ekon) carries the same logic: set once, per protagonist, before play begins. Aspect ratio does not belong in this list. It is a different kind of system entirely, and is handled separately below (The Frame) rather than forced to look like a third fixed baseline it isn't.**
...
**Nobody goes out to the island anymore, and hasn't for longer than anyone still living can account for. It isn't avoided the way a haunted place is avoided — Widow's Bight doesn't tell itself a story about the island being cursed or dangerous, doesn't warn children off it, doesn't mark it on any map as anything worse than empty. It has simply stopped occurring to anyone as somewhere a person would go, the same incuriosity the town already extends to its own founding, aimed now at a smaller and closer target. Ward, when he arrives, is the first person in a generation with any real reason to set foot there at all.**
...
**His central failure, and the hinge Chapter Three turns on: he gave more weight to the town's elite men than to a housemaid's own account, and let that account arrive too late in his own sequence to matter. She is named, Sarah Munn, across all three canonical tellings (see Supporting Cast, below), but the mechanism of contact differs by telling: in the mixed-method telling she gives Walter her testimony directly, face to face; in the other two she reaches him only through her trail — a contradicting account filed and underweighted beneath a signed man's word, or a payroll scrap Walter follows weeks after he should have. She does not vanish in any telling — the failure is not that she disappears, only that Walter's own habits of weight and sequence bury her account regardless of whether she is standing in front of him the whole time. This is ordinary, human bias — the same limited epistemic bubble that later fails him against the entity — not supernatural interference. His death cuts an investigation short that his own prejudice was already failing before he ever died.**
...
**\- \*\*Sarah Munn\*\* — the housemaid whose account Walter's central failure specifically fails, named across all three canonical tellings. She worked the estate's kitchen alongside the murdered mother and left the position three weeks before the murders; the document at the center of her account is a paper the mother confided naming a debt owed her family from the whaling years, which Sarah, afraid to be caught holding it, gave back. She survives the chapter in every telling. In the mixed-method telling, she confirms all of this to Walter directly — he interviews her at her sister's rooms above the chandlery — and her statement arrives late in his own sequence of witnesses, weighed against the club's denials exactly as the central-failure line describes. In the two pre-existing tellings, Walter never sits across from her: her contradicting account of a disputed club night is filed, unresolved, beneath a steward's signed statement, or her employment (and so her trail) is denied outright by the man who employed her, and Walter reconstructs her account from a payroll scrap weeks after he should have had it from her own mouth. The mechanism of contact differs by telling; it is always her account, not any cultist's, that Walter should have moved on faster than he did.**
...
**The county's own file closes within weeks, while Walter is still alive and still working the case on his own time: the six men's deaths ruled a gas-main failure and mourned in full; the mother and son filed separately, under their own recovered names, as transients — a record that exists, technically satisfies any future clerk who goes looking for one, and accomplishes exactly the same erasure an outright omission would have, since a name filed under the wrong word is exactly as unfindable, to anyone not already looking for it, as a name never filed at all. Walter never manages to connect the two records before his own death, and no successor ever revisits either one, because no successor is ever told there was anything left to revisit. The true count that night was eight. The record, permanently, reads as six respectable dead and two of no consequence — never as eight, and never as one event. This produces the first of several dishonest documents that recur across the trilogy (see Part Six).**
...
**A Black WWII veteran. First name Ekon — Efik/Ibibio Nigerian in origin, meaning "strong," chosen deliberately by his mother as an act of naming her son what she wanted the world to have to reckon with, consistent with the real, if still uncommon, pan-African naming currents of the 1910s–1920s (Garveyism-adjacent). Surname Freeman — a real, documented surname pattern adopted by formerly free or newly emancipated Black Americans to state their legal status outright. His own family line, however, traces not to formerly enslaved ancestry but to a free Black whaling lineage: Massachusetts abolished slavery through its own courts and constitution in the 1780s, decades before the Ophion's loss in the 1820s, and coastal Massachusetts had substantial, well-documented free Black maritime communities well before the Civil War. The ancestor who sailed and died with the Ophion was free by law from the start — which makes the town's later dismissal of his mother and brother as rootless transients not just cruel, but a specific, disprovable lie: this family's claim to that coastline predates the wealthy families' fortune by a full generation. His baseline color and its origin are established in Part One, The Baseline. His baseline sound is a close, deadened hush — the specific muffling of a man who came back from a war with a permanent ringing under everything else he hears, so that even the island's genuine silences arrive to him half-damped, never quite clean. It is not a symptom the chapter treats as a condition to manage or cure; it is simply how the world already sounds to him before anything cosmic touches it, the sound-channel counterpart to a color grade he was carrying long before Widow's Bight, and it never resolves the way Ward's arc does — competence changes what Ekon can do about a threat, never what he hears.**
...
**\- \*\*The wage claim / lay documentation itself\*\* — hidden by her, preserved (if reluctantly) by the lawyer she'd engaged (Yoss), and physically recovered by Ekon.**
...
**Presentation instability already established for the case file (Design Law 4\) may extend to the summoned interface as cosmetic stress only — grain, aspect, or register that makes consulting feel like part of the same medium — never as altered outcomes, lost inventory, or misregistered input. The underlying game state remains fair and complete; the shell may look like it is under pressure. That pressure must never be mistakable for a broken build.**
...
**The archive should make the friction between the town's official record and the player's authored consequences legible — not as a scored redemption, and not as new content, but as the same Design Law 6 states the chapters already produce, shown side by side where that contrast is the point (Walter's stubborn "eight" against the town's official "six"; sealed or burned documents against the orderly lies that outlived them). Presentation may carry that friction; it must never invent a morality score or a victory condition the Laws forbid.**
