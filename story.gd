...
const FACTS = {
	...
	"testimony": ["BOTH SCENES", "The assistant counted eight and saw no evidence of an explosion. She was told to prepare the six club members first. Her observations corroborate the separate scene notes.", "Coroner's assistant · statement"],
