...
const VERSION=1
const DEFAULTS={"grain":0.018,"distortion":0.25,"contrast":1.0,"text_scale":1.0,"sensitivity":0.0026,"camera_speed":1.0,"reduced_flicker":true,"hints":true,"invert_y":false}
const RANGES={"grain":[0.0,0.06],"distortion":[0.0,1.0],"contrast":[0.8,1.4],"text_scale":[0.9,1.3],"sensitivity":[0.001,0.006],"camera_speed":[0.2,3.0]}
