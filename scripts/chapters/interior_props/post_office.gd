...
const PROPS: Array[Dictionary] = [
	...
	{"id":"PostOfficeBalanceScale", "path":"res://assets/models/props/civic/post_office_balance_scale.glb", "pos":Vector3(-2.0,1.0,-2.25), "yaw":0.0, "scale":0.92, "support":"on:PostOfficeCounterLeft:top", "clearance_check":false},
	...
	{"id":"PostOfficePendantLeft", "path":"res://assets/models/props/civic/post_office_pendant_a.glb", "pos":Vector3(-3.2,3.02,0.7), "yaw":0.0, "scale":1.18, "support":"ceiling", "cast_shadow":false, "clearance_check":false},
	{"id":"PostOfficePendantRight", "path":"res://assets/models/props/civic/post_office_pendant_b.glb", "pos":Vector3(3.2,3.02,0.7), "yaw":0.0, "scale":1.18, "support":"ceiling", "cast_shadow":false, "clearance_check":false},
