...
const BUILDINGS = {
	...
	"lower": [
		["lower_house_1","DWELLING No. 1","home","light"],
		["lower_house_2","DWELLING No. 2","home","light"],
		["lower_house_3","DWELLING No. 3","home","light"],
		["lower_house_4","DWELLING No. 4","home","light"],
		["speakeasy","DWELLING No. 5","speakeasy","occupied"],
		["lower_house_6","DWELLING No. 6","home","exterior"]]
}
const HUB_TITLES = {"waterfront":"The waterfront","upper":"Upper residential quarter","business":"Business district","lower":"Lower residential quarter","morgue":"Precinct morgue","post_office":"Pickman Street post office","speakeasy":"The Cellar Cask"}
