...
const SLOTS = {
	...
	"pickman_post_walk":["town",Vector3(-22,0,14)], "pickman_estate_walk":["town",Vector3(-27,0,10)],
	"pickman_repair_walk":["town",Vector3(25,0,-1)],
	"business_school_walk":["business",Vector3(-21,0,1)], "business_museum_walk":["business",Vector3(-8,0,1)],
	"business_stationer_walk":["business",Vector3(7,0,1)], "business_repair_walk":["business",Vector3(23,0,1)],
	"business_school_crossing":["business",Vector3(-24,0,15)], "business_museum_crossing":["business",Vector3(-10,0,15)],
	"business_printer_crossing":["business",Vector3(5,0,15)], "business_clock_crossing":["business",Vector3(21,0,15)],
	"upper_west_pavement":["upper",Vector3(-18,0,-1)], "upper_center_pavement":["upper",Vector3(-5,0,-1)],
	"upper_east_pavement":["upper",Vector3(12,0,-1)], "upper_far_pavement":["upper",Vector3(27,0,-1)],
	"upper_west_road":["upper",Vector3(-27,0,6)], "upper_center_road":["upper",Vector3(-5,0,7)],
	"upper_east_road":["upper",Vector3(12,0,7)], "upper_far_road":["upper",Vector3(27,0,7)],
	"lower_west_pavement":["lower",Vector3(-24,0,-1)], "lower_midwest_pavement":["lower",Vector3(-11,0,-1)],
	"lower_center_pavement":["lower",Vector3(3,0,-1)], "lower_mideast_pavement":["lower",Vector3(16,0,-1)],
	"lower_east_pavement":["lower",Vector3(27,0,-1)], "lower_west_line":["lower",Vector3(-22,0,15)],
	"lower_center_line":["lower",Vector3(-5,0,15)], "lower_east_line":["lower",Vector3(24,0,15)],
	"waterfront_west_quay":["waterfront",Vector3(-28,0,4)], "waterfront_midwest_quay":["waterfront",Vector3(-14,0,4)],
	"waterfront_center_quay":["waterfront",Vector3(0,0,4)], "waterfront_mideast_quay":["waterfront",Vector3(12,0,4)],
	"waterfront_east_quay":["waterfront",Vector3(28,0,4)], "waterfront_west_apron":["waterfront",Vector3(-12,0,-6)],
	"waterfront_center_apron":["waterfront",Vector3(8,0,-6)], "waterfront_east_apron":["waterfront",Vector3(27,0,-6)],
