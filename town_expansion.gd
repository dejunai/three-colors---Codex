...
const UpperParlorProps = preload("res://scripts/chapters/interior_props/upper_parlor.gd")
const PostOfficeProps = preload("res://scripts/chapters/interior_props/post_office.gd")
...
func _dress(kind:String) -> void:
	match kind:
		...
		"parlor":
			_place_props(UpperParlorProps.PROPS)
		"home":
...
func _post_office() -> void:
	...
	_place_props(PostOfficeProps.PROPS)
