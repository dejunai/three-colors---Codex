...
func run(g:Node) -> void:
	...
	for body in g.estate.scene_bodies: assert(not body.visible)
	for id in ["wounds","eight","watch","shoes","knife"]: assert(not g.estate.points.has(id))
