...
tests = [
    ...
    (["--headless", "--path", ".", "--script", "res://tests/batch6_prop_assets_flow.gd"], "batch6_prop_assets_flow"),
    (["--headless", "--path", ".", "--script", "res://tests/batch7_post_office_assets_flow.gd"], "batch7_post_office_assets_flow"),
    (["--headless", "--path", ".", "--script", "res://tests/batch8_replacement_assets_flow.gd"], "batch8_replacement_assets_flow"),
